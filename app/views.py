...
def after_login(request):
    ...
    Admission_number=request.POST.get('Admission_number','No Admission no')
    email=request.session.get('email','No Email')
    Father_name=request.session.get('Father_name','Father_name')
    d={'user_name':user_name,'Admission_number':Admission_number,'email':email,'Father_name':Father_name}
